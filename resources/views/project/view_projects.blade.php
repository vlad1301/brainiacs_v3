                        ...
                        <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
                            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile ">
                                <ul class="kt-menu__nav">
                                    <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Project Setup Guide!</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                        </div>
                                    </li>
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">SEO Tips & Tricks</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                            <ul class="kt-menu__subnav">
                                                <li class="kt-menu__item " aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Managing a project</span></a></li>
                                                <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover" aria-haspopup="true"><a href="#" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">How to use the rank tracker</span></a>
                                                </li>
                                                <li class="kt-menu__item " aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Backlinks Tracking How-To</span></a></li>
                                                <li class="kt-menu__item " aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">SEO Audit Tool Guide</span></a></li>
                                                <li class="kt-menu__item " aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">SEO Crawler/Spider Guide</span></a></li>
                        ...
                        <div class="kt-portlet">
                            ...
                            <!--end::Section-->
                                                ...
                                                <div class="kt-iconbox__body">
                                                    ...
                                                    <div class="kt-iconbox__desc">
                                                        ...
                                                        <div class="kt-iconbox__content">
                                                            First thing would be to create a <b>New Project</b> for your domain. You will be able to check the rankings and use the full stack of available tools.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="kt-iconbox__body">
                                                    ...
                                                    <div class="kt-iconbox__desc">
                                                        ...
                                                        <div class="kt-iconbox__content">
                                                            Not sure on what should you choose for the project settings? Please check our in-depth <a class="kt-link" href="https://www.seobrainiacs.com/"><b>tutorials</b></a> in order to understand all the features.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="kt-portlet kt-iconbox">
                                            <div class="kt-portlet__body">
                                                <div class="kt-iconbox__body">
                                                    ...
                                                    <div class="kt-iconbox__desc">
                                                        <h3 class="kt-iconbox__title">
                                                            <a class="kt-link" href="#">User Management</a>
                                                        </h3>
                                                        <div class="kt-iconbox__content">
                                                            After adding your project you will be able to enable various users (as sub-accounts) to see certain data for each individual project.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="kt-portlet">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section">
                                            <div class="kt-section__content " style="text-align: center">
                                                <button type="button" class="btn btn-primary btn-lg">Create a new project</button>
                                                <br>
                                            </div>
                                        </div>
                        ...
                        <div class="kt-footer__top">
                            <div class="kt-container ">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="kt-footer__section">
                                            ...
                                            <div class="kt-footer__content">
                                                SEO Brainiacs is a multi-purpose SEO optimization SaaS that offers a toolkit of solutions.
                                                It is developed by Rocerber International and Wisvision Romania in association with Clickbrainiacs Marketing Solutions.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="kt-footer__section">
                                            <h3 class="kt-footer__title">Utils</h3>
                                            <div class="kt-footer__content">
                                                <div class="kt-footer__nav">
                                                    <div class="kt-footer__nav-section">
                                                        <a href="https://www.seobrainiacs.com/how-it-works/">How it works</a>
                                                        <a href="https://www.seobrainiacs.com/faq/">F.A.Q</a>
                                                        <a href="https://www.seobrainiacs.com/pricing/">Pricing</a>
                                                    </div>
                                                    <div class="kt-footer__nav-section">
                                                        <a href="https://www.seobrainiacs.com/setup-guide/">Setup Guide</a>
                                                        <a href="https://www.seobrainiacs.com/usefull-tips/">Usefull tips</a>
                                                        <a href="https://www.seobrainiacs.com/contact/">Support</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="kt-footer__section">
                                            <h3 class="kt-footer__title">Join our Newsletter</h3>
                                            <div class="kt-footer__content">
                            ...
                            <div class="kt-container ">
                                <div class="kt-footer__wrapper">
                                    <div class="kt-footer__copyright">
                                        &copy; 2019-2020 <a href="http://www.seobrainiacs.com" target="_blank">SEOBrainiacs</a>
                                    </div>
                                    <div class="kt-footer__menu">
                                        <a href="https://www.seobrainiacs.com/licensing/" target="_blank">Licensing & Partnerships</a>
                                        <a href="https://www.seobrainiacs.com/team/" target="_blank">Our Team</a>
                                        <a href="https://www.seobrainiacs.com/contact/" target="_blank">Contact</a>
                                    </div>
                                </div>
                            </div>
                        </div>
